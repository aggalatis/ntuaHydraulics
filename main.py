...
class MainApp(QWidget):
    ...
    def create_app(self):
        ...
        generate_data_cells = QPushButton("Εισαγωγή δεδομένων διατομής / ροής")
        ...
        grid.addWidget(generate_data_cells, 4, 0, 1, 2)
        grid.addWidget(save_button, 4, 2, 1, 2)
        grid.addWidget(read_button, 6, 0, 1, 2)
        grid.addWidget(execute_button, 6, 2, 1, 2)
        ...
        self.hide_widget(self.width, self.width_label)
